...
1. **File trọng số của YOLO và ảnh chuẩn**
   ...
   - **Link tải:** [Tải file trọng số YOLO và ảnh ]([https://example.com/path/to/yolo11x_box10_50ep.pt](https://drive.google.com/drive/folders/1IlJGSQp7N5JLvW9lUa8cSQeIIBvHCCZo?usp=sharing))
